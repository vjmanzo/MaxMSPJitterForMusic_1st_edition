...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 764.400024, 472.200073, 143.0, 40.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 1.400024, 257.200073, 62.0, 40.0 ],
					"style" : "",
					"text" : "EAMIR\ncreated by\nV.J. Manzo"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-25",
					"items" : [ "AU DLS Synth 1", ",", "IAC Driver Bus 1", ",", "Dan's Drums", ",", "FireFace? Port 2", ",", "from Max 1", ",", "from Max 2", ",", "to Max 1", ",", "to Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
